...
public class CostantiStatiche {
    ...
    public static final int[][] POCKET_POSITIONS = {
            //BUCA TOP LEFT
            {BORDER_WIDTH - BIG_POCKET_RADIUS, BORDER_WIDTH - BIG_POCKET_RADIUS, BIG_POCKET_RADIUS * 2, BIG_POCKET_RADIUS * 2},
            //BUCA TOP
            {(TABLE_WIDTH / 2) - POCKET_RADIUS, BORDER_WIDTH - POCKET_RADIUS - 5, POCKET_RADIUS * 2, POCKET_RADIUS * 2},
            //BUCA TOP RIGHT
            ...
            //BUCA BOTTOM RIGHT
            {TABLE_WIDTH - BORDER_WIDTH - BIG_POCKET_RADIUS, TABLE_HEIGHT - BORDER_WIDTH - BIG_POCKET_RADIUS,
                    BIG_POCKET_RADIUS * 2, BIG_POCKET_RADIUS * 2}
    };
}
